    ...
    <MotionSection className="px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="mb-9 max-w-3xl sm:mb-10">
          ...
          <h2 className="max-w-3xl text-balance text-[clamp(2.45rem,11vw,4.5rem)] font-black uppercase leading-[0.98] tracking-[-0.02em] text-[#F1E6CF] lg:text-5xl heading-wordspace">
            {pricing.heading}
          </h2>
